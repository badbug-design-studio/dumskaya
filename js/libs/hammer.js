...
//            h.get('swipe').set({ direction: Hammer.DIRECTION_VERTICAL });
            h.on( 'panstart', _dragStart );
            h.on( 'pandown', _dragDown );
        ...
        var _dragStart = function(e) {
            drag.startingPositionY = options.contentEl.scrollTop;
        ...
        var _dragDown = function(e) {
            ...
            drag.distance = e.distance / 2.5; // Provide feeling of resistance
            // Use transforms to smoothly animate elements on desktop and mobile devices
            options.contentEl.style.transform = options.contentEl.style.webkitTransform = 'translate3d( 0, ' + drag.distance + 'px, 0 )';
//            options.ptrEl.style.transform = options.ptrEl.style.webkitTransform = 'translate3d( 0, ' + ( options.ptrEl.offsetHeight ) + 'px, 0 )';
            options.contentEl.style.pointerEvents = "none";
        ...
        var _dragEnd = function(e) {
            ...
            options.contentEl.style.pointerEvents = "auto";
